...
<head>
    ...
    <style type="text/css" media="screen">
        ...
        .gradient {
            background: linear-gradient(to right, #B12009 0%, #1c2124 100%);
        }
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td class="mpx-10">
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td class="p-15 mpx-15" bgcolor="#B12009"
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td class="text-14 lh-24 a-center c-white l-white pb-20"
                                                                    ...
                                                                    <h3 class="c-white">Happy Betting</h3>
                                                                    <span class="d-block">Value8 Group</span>
                                                                    ...
                                                                    <a href="{{ config('app.firm_url') }}"
                                                                        target="_blank" class="link c-white d-block"
                                                                        style="text-decoration:none; color:#ffffff;"><span
                                                                            class="link c-white"
                                                                            style="text-decoration:none; color:#ffffff;"></span></a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td class="text-12 lh-22 a-center c-grey- l-grey py-20"
                                                        ...
                                                        <a href="{{ config('app.firm_url') }}" target="_blank"
                                                            ...
                                                            style="text-decoration:none; color:#6e6e6e;"><span
                                                                class="link c-grey"
                                                                style="white-space: nowrap; text-decoration:none; color:#6e6e6e;">{{ date('Y') }}
